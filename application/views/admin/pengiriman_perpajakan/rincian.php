<div class="content container-fluid">
	...
	<div class="row content-header">
		...
		<div class="col-auto">
			<a href="<?=base_url('admin/pengiriman/pengiriman_data_perpajakan')?>" class="btn btn-secondary">Kembali</a>
		</div>
	</div>
					...
					<tr>
						...
						<td>
							<?php if( $detail['format_data'] == 'Softcopy' ) : ?>
								<a href="<?=base_url('admin/pengiriman/pengiriman_data_perpajakan/download?k='.$detail['id_klien'].'&y='.$detail['tahun'].'&f='.$p['file'])?>" target="">
									<?=$p['file']?>
								</a>
							<?php else : ?>
								<?=$p['file']?>
