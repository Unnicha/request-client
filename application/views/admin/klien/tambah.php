					...
					<form action="" method="post" id='myForm'>
						...
						<div id="tabs">
							...
							<div class="add-klien ">
								...
								<div class="form-group row">
									<div class="col-sm">
										<input type="text" name="email_pimpinan" id="emailPim" class="form-control email" placeholder="Email" data-cek="email" value="<?= set_value('email_pimpinan') ?>">
							...
							<div class="add-klien ">
								...
								<div class="form-group row">
									<div class="col">
										<input type="text" name="email_counterpart" id="emailCp" class="form-control email" placeholder="Email" data-cek="email" value="<?= set_value('email_counterpart') ?>">
...
<script>
	...
	function validation() {
		...
		for(var i=1; i <= $('.form-active').length; i++) {
			...
			var errorMsg = '';
			// cek apakah field ada isinya. jika field tidak kosong ...
			if(val != '') {
				// cek apakah ada validasi. jika validasi tidak kosong ...
				if(cek != null) {
					// lakukan validasi
					cek = cek.split('|');
				...
				if(cek != null && cek.search('required') > -1) {
					errorMsg = front +' harus diisi!';
					field.addClass('has-error');
					result = false;
				}
				$('#error_'+id).text(errorMsg);
