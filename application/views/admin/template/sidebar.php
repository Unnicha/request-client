<nav id="sidebarMenu" class="col-md-3 col-lg-2 mt-4 mt-md-0 d-md-block p-0 sidebar collapse">
	...
	<div class="sidebar-sticky pt-0 pb-5">
		<!-- Beranda -->
		<a href="<?= base_url(); ?>admin/home" id='home' class="btn btn-block text-left sidebar-header">
...
<script>
	$(document).ready(function() {
		...
		console.log(arr1[2])
		if (arr1[3] == 'home') {
			$('#sidebarMenu .sidebar-sticky #home').addClass('active');
		}
		...
		// $.ajax({
		// 	type	: 'POST',
		// 	url		: '<?= base_url(); ?>admin/home/sendMail',
